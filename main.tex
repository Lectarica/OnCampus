...
次にプログラムの編集および開発に用いるエディタとして、Visual Studio Code(VSCode)を導入する。VSCodeは軽量で拡張性が高いこと、またRemoteによりWSL環境との連携も容易であるために、本稿では標準的な開発環境として採用します。\footnote{ところでsshなどで大学のスパコンを用いる場合、標準装備されているエディタがemacsである場合もあります。}
